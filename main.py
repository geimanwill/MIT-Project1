...
result = p1.classifier_accuracy(p1.pegasos, train_bow_features, test_bow_features, train_labels, test_labels, T = 25, L = .01)
print(result)
...
best_theta = p1.pegasos(train_bow_features, train_labels, T=25, L=.01)[0]
